...
function CoreStats({CoreStatsData:{floorPrice,topBid,totalListed,totalSupply,owners}}:CoreStatsProps) {
  ...
  return (
    <>
      <div className="rounded-3xl bg-gradient-to-br from-[#81114257] to-[#863A5C3E] p-6 text-white">
        <h3 className="mb-4 text-2xl font-bold">Core Stats</h3>
        ...
        <div className="grid grid-cols-2 grid-rows-3 gap-2">
          ...
          <div className="mb-1 flex flex-col ml-5">
